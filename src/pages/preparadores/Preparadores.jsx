...
import { AdicionarPreparadores } from './AdicionarPreparadores'
import { api } from '../../service/api'

const TABLE_HEAD = ["ID", "Nome", "E-mail", "Empresa", "Proprietário", ""]; 

export const Preparadores = () => {
